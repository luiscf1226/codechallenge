                                ...
                                <div class="relative flex items-center gap-6 lg:items-end">
                                    <div id="docs-card-content" class="flex items-start gap-6 lg:flex-col">
                                        ...
                                        <div class="pt-3 sm:pt-5 lg:pt-0">
                                            <h1 class="text-xl font-semibold text-black">¡Bienvenidos al Code Challenge!</h1>

                                            <h2 class="text-xl font-semibold text-black">Puedes seguir los siguientes pasos para completar la navegación</h2>

                                            <h4>PD: He decidido utilizar Jetstream y Livewire con CSS espero no haya problemas :happyface</h4>
                                        </div>
                                    </div>
